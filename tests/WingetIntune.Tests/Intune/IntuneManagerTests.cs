...
public class IntuneManagerTests
{
    ...
    {
        var intuneManager = new IntuneManager(new NullLogger<IntuneManager>(), null, null, null, null, null);
...
";
        ...
        var intuneManager = new IntuneManager(new NullLogger<IntuneManager>(), fileManagerMock.Object, processManagerMock.Object, null, null, null);
    ...
    public async Task DownloadLogoAsync_CallsFilemanager()
    {
        ...
        var intuneManager = new IntuneManager(new NullLogger<IntuneManager>(), fileManagerMock.Object, null, null, null, null);
